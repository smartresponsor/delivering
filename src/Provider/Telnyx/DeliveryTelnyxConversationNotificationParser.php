...
final readonly class DeliveryTelnyxConversationNotificationParser
{
    ...
    public function parse(string $json, string $timestamp): ?DeliverySendSms
    {
        try {
