...
final readonly class DeliveryDeliveryTelemetryService
{
    ...
    public function failed(
        ...
        $classification = match (true) {
            $exception instanceof DeliveryPermanentTransportException => 'permanent',
            $exception instanceof DeliveryTransportException => 'transient',
            default => 'unknown',
        };
        $context = $this->context(
            correlationId: $correlationId,
