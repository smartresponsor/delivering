...
final class DeliveringDeliveryTest extends TestCase
{
    public function testIgnoreOutOfOrderReceipt(): void
    {
        ...
        $delivery->applyReceipt(DeliveringDeliveryStatus::Delivered, new DateTimeImmutable('2026-07-26T12:02:00+00:00'));
        $delivery->applyReceipt(DeliveringDeliveryStatus::Sent, new DateTimeImmutable('2026-07-26T12:01:00+00:00'));

        self::assertSame(DeliveringDeliveryStatus::Delivered, $delivery->status());
    }
    ...
    public function testAcceptNewerReceipt(): void
    {
        ...
        $delivery->applyReceipt(DeliveringDeliveryStatus::DeliveryFailed, new DateTimeImmutable('2026-07-26T12:03:00+00:00'));

        self::assertSame(DeliveringDeliveryStatus::DeliveryFailed, $delivery->status());
    }
}
