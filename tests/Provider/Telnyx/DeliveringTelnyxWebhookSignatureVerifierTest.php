...
final class DeliveringTelnyxWebhookSignatureVerifierTest extends TestCase
{
    public function testVerifyValidSignature(): void
    {
        ...
        $verifier = new DeliveringTelnyxWebhookSignatureVerifier(base64_encode($publicKey));
